    ...
    function XlsxEditor({ scope, path, title, customData }) {
      ...
      function updateStyle(r, c, patch) {
        ...
        var sheets = wb.sheets.map(function (sheet) {
          ...
          var rows = cloneRows(sheet.rows || [])
          while (rows.length <= r) rows.push([])
          while (rows[r].length <= c) rows[r].push({ v: '', f: undefined, font: undefined })
          var prev = rows[r][c] || { v: '', f: undefined }
          var font = Object.assign({}, prev.font || {}, patch)
          rows[r][c] = { v: prev.v, f: prev.f, bg: prev.bg, font: font }
      ...
      return h('div', { style: { display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' } },
        ...
        h('div', { style: { display: 'flex', alignItems: 'center', gap: 6, padding: '3px 8px', borderBottom: '1px solid #ddd', background: '#fff', fontSize: 12 } },
          ...
          h('input', {
            ...
            onChange: function (e) { if (sel && sel.r !== undefined) updateStyle(sel.r, sel.c, { color: hexToArgb(e.target.value) }) },
            title: '字体颜色',
              ...
              Array.from({ length: rowCount }, function (_, r) {
                ...
                return h('tr', { key: r },
                  ...
                  Array.from({ length: colCount }, function (_, c) {
                    ...
                    var tdStyle = { border: '1px solid #ddd', padding: 0, position: 'relative', background: isSelected ? '#eef2ff' : (inRange ? 'rgba(22,93,255,0.25)' : (bg || undefined)) }
                    ...
                    return h('td', {
                      ...
                      children: [
                        h('input', {
                          ...
                          value: displayValue,
                          onFocus: function () { selectCell(r, c) },
                          onChange: function (e) {
