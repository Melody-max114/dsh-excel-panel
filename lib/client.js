    ...
    function XlsxEditor({ scope, path, title, customData }) {
          ...
          for (var rr = rangeToApply.r1; rr <= rangeToApply.r2; rr++) {
            for (var cc = rangeToApply.c1; cc <= rangeToApply.c2; cc++) {
              ...
              if (Object.prototype.hasOwnProperty.call(patch, 'bg')) {
                ...
                } else if (Object.prototype.hasOwnProperty.call(patch, 'align')) {
                  rows[rr][cc] = { v: prev.v, f: prev.f, bg: prev.bg, font: prev.font, align: patch.align }
              } else {
      ...
      return h('div', { style: { display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' } },
        ...
        h('div', { style: { display: 'flex', alignItems: 'center', gap: 6, padding: '3px 8px', borderBottom: '1px solid #ddd', background: '#fff', fontSize: 12 } },
          ...
          h('button', {
            onClick: function () { if (sel && sel.r !== undefined) updateStyle(sel.r, sel.c, { align: 'left' }) },
            title: '左对齐',
          ...
          h('button', {
            onClick: function () { if (sel && sel.r !== undefined) updateStyle(sel.r, sel.c, { align: 'center' }) },
            title: '居中',
          ...
          h('button', {
            onClick: function () { if (sel && sel.r !== undefined) updateStyle(sel.r, sel.c, { align: 'right' }) },
            title: '右对齐',
